...
// --- offset-aware parsing -------------------------------------------------
// The legacy ``splitChainFilters`` / ``splitFilterArgs`` above stay for any
// external callers, but ``parseFilterComplex`` now does its own splitting while
